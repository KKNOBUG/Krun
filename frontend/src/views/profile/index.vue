        ...
        <div class="m-30 flex items-center">
          <NForm
            ...
            <NFormItem :label="$t('views.profile.label_avatar')" path="avatar">
              <NImage width="100" :src="userStore.avatar"></NImage>
            </NFormItem>
            ...
            <NFormItem :label="$t('views.profile.label_alias')" path="alias">
              <NInput
                  v-model:value="infoForm.alias"
                  type="text"
                  :placeholder="$t('views.profile.placeholder_alias')"/>
            </NFormItem>
            <NFormItem :label="$t('views.profile.label_phone')" path="phone">
              <NInput
                  v-model:value="infoForm.phone"
                  type="text"
                  :placeholder="$t('views.profile.placeholder_phone')"/>
            </NFormItem>
