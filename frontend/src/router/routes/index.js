    ...
    children: [
      {
        name: 'py38api',
        path: 'py38api',
        component: () => import('@/views/toolbox/py38api/index.vue'),
        // component: () => {
        //   console.log('开始加载组件: @/views/toolbox/py38api/index.vue');
        //   return import('@/views/toolbox/py38api/index.vue').then((component) => {
        //     console.log('组件加载成功:', component);
        //     return component;
        //   }).catch((error) => {
        //     console.error('组件加载错误:', error);
        //     // 可以在这里进行其他处理，比如跳转到错误页面
        //   });
        // },
        meta: {
          title: 'Python 官方文档',
