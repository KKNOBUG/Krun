...
CELERY_CONFIG: Dict[str, Any] = {
    ...
    # 任务路由配置
    "task_routes": {
        "backend.services.celery_service.execute_batch_cases_task": {"queue": "autotest_queue"},
    },
    ...
    "redbeat_lock_timeout": 30,  # Beat锁超时时间（秒），防止多Beat进程冲突
    ...
    # 任务导入配置
    "imports": (
        "backend.services.celery_service",
    ),
