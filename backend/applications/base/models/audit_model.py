...
class Audit(ScaffoldModel, TimestampMixin):
    ...
    request_time = fields.DatetimeField(description="请求时间")
    ...
    response_time = fields.DatetimeField(description="响应时间")
    response_header = fields.JSONField(default=None, null=True, description="响应头部")
    response_code = fields.CharField(max_length=16, default="", null=True, description="响应代码")
