...
class AutoTestApiDetailBase(AutoTestApiDetailReqBase, AutoTestApiDetailVarBase, AutoTestApiDetailResBase):
    ...
    loop_iter_idx: Optional[str] = Field(default=None, max_length=64, description="本次执行循环索引变量名")
    loop_iter_key: Optional[str] = Field(default=None, max_length=64, description="本次执行循环字典键变量名")
    loop_iter_val: Optional[str] = Field(default=None, max_length=64, description="本次执行循环值变量名")
