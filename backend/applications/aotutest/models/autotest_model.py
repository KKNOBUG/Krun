...
class AutoTestApiCaseInfo(ScaffoldModel, MaintainMixin, TimestampMixin, StateModel, ReserveFields):
    ...
    case_type = fields.CharEnumField(AutoTestCaseType, default=None, description="用例所属类型")
    case_attr = fields.CharEnumField(AutoTestCaseAttr, default=None, description="用例所属属性")
