...
from backend.enums.autotest_enum import CaseType, StepType, ReportType, LoopMode, LoopErrorStrategy
...
class AutoTestApiEnvInfo(ScaffoldModel, MaintainMixin, TimestampMixin, StateModel):
...
class AutoTestApiCaseInfo(ScaffoldModel, MaintainMixin, TimestampMixin, StateModel):
    ...
    case_type = fields.CharEnumField(CaseType, default=CaseType.PRIVATE_SCRIPT, null=True, description="用例所属类型")
...
class AutoTestApiStepInfo(ScaffoldModel, MaintainMixin, TimestampMixin, StateModel):
    ...
    step_type = fields.CharEnumField(StepType, description="步骤类型")
...
class AutoTestApiReportInfo(ScaffoldModel, MaintainMixin, TimestampMixin, StateModel):
    ...
    report_type = fields.CharEnumField(ReportType, description="报告类型")
